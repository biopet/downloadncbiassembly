...
#  About this tool
This tool downloads an assembly from NCBI.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-DownloadNcbiAssembly.readthedocs.io/en/latest/).
