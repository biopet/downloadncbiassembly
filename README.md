...
For documentation and manuals visit our [github.io page](https://biopet.github.io/downloadncbiassembly).

# About


DownloadNcbiAssembly is part of BIOPET tool suite that is developed at LUMC by [the SASC team](http://sasc.lumc.nl/).
...
For any question related to DownloadNcbiAssembly, please use the
<a href='https://github.com/biopet/downloadncbiassembly/issues'>github issue tracker</a>
or contact
